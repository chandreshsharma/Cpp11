...
///////////////////////// time_point (template_class)
    ...
    std::chrono::steady_clock::duration dur = std::chrono::steady_clock::now() - t0;
    
    //  std::cout << "Printing using cout took: " << std::chrono::duration_cast<std::chrono::microseconds>(dr).count() << std::endl;
    std::cout << "Printing using cout took: " << dur.count() << std::endl;
    
    t0 = std::chrono::steady_clock::now();
    std::cerr << "Hello C++ 11" << std::endl;
    dur = std::chrono::steady_clock::now() - t0;
    std::cout << "Printing using cerr took: " << dur.count() << std::endl;
